...
export function renderAmudGrid(containerId, amudStates, isBunched = false) {
    ...
    amudStates.forEach((state, i) => {
        ...
        // Colors matching your existing palette logic
        let colorClass = "bg-slate-100 text-slate-400 border-slate-200"; // Unlearned
        if (state === 1) colorClass = "bg-emerald-500 text-white border-emerald-600 shadow-sm"; // Learned
        if (state === 2) colorClass = "bg-amber-500 text-white border-amber-600 shadow-sm";   // Skipped
